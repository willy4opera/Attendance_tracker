    ...
    <div className="min-h-screen bg-gray-50 px-4 lg:px-8 py-4 lg:py-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          {/* Instructions */}
          <div className="border rounded-lg p-6 max-w-2xl mx-auto text-center" style={{ 
            backgroundColor: theme.colors.primary + '10',
            borderColor: theme.colors.primary + '50'
          }}>
            <QrCode className="w-12 h-12 mx-auto mb-4" style={{ color: theme.colors.primary }} />
            <h4 className="text-lg font-medium text-black mb-4">How to mark attendance:</h4>
            <div className="space-y-2 text-sm text-gray-700 max-w-md mx-auto">
              <p>1. Ask your session host for the QR code or attendance code</p>
              <p>2. Either scan the QR code using your camera or enter the code manually</p>
